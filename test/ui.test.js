...
describe('UI Testing using Selenium', function() {
    ...
    it('should load the login page', async function() {
        await driver.get('D:/SISTEM INFORMASI/SEMESTER 5/PPMPL/PRAK/P4/selenium-ui-test/login.html'); // Ubah path sesuai lokasi file login.html
    ...
    it('should input username and password using CSS Selector and XPath', async function() {
        ...
        await driver.get('D:/SISTEM INFORMASI/SEMESTER 5/PPMPL/PRAK/P4/selenium-ui-test/login.html');
